...
class TestProceedingsTitleParser(unittest.TestCase):
    ...
    def testExampleResult(self):
        ...
        expected=[
            {
                'enum': 'Thirty-First','daterange': None, 'description': None, 'event': 'Conference','extract': None, 'field': None, 'location': None, 'month': 'February', 'ordinal': None, 'organization': None, 
            ...
            {
                'daterange': None, 'enum': None, 'description': None, 'event': 'Summit', 'extract': None,'field': None, 'location': None, 'month': None, 'ordinal': None, 'organization': None, 'prefix': None, 
            ...
            {
                'daterange': None, 'enum': None, 'description': None, 'event': 'Workshop', 'extract': None,'field': None, 'location': 'virtual', 'month': None, 'ordinal': None, 'organization': None, 'prefix': None, 
